...
export class MatchingService {
  ...
  private readonly configuracionMatching: ConfiguracionMatching = {
    criterios: [
      {
        nombre: 'Diagnósticos',
        peso: 0.35,
        descripcion: 'Coincidencias Diagnósticas (35%)',
      },
      {
        nombre: 'Temas',
        peso: 0.25,
        descripcion: 'Coincidencias Temáticas (25%)',
      },
      {
        nombre: 'Estilo',
        peso: 0.2,
        descripcion: 'Coincidencias de Estilo Terapéutico (20%)',
      },
      { nombre: 'Enfoque', peso: 0.1, descripcion: 'Enfoque teórico (10%)' },
      { nombre: 'Afinidad', peso: 0.1, descripcion: 'Afinidad Personal (10%)' },
    ],
    ...
    mapeosDiagnosticos: [
      {
        paciente: 'Ansiedad',
        psicologo: [
          'Trastornos de ansiedad (incluye crisis de pánico, ansiedad generalizada, ansiedad social)',
        ],
        peso: 1,
      },
      {
        paciente: 'Depresión',
        psicologo: ['Episodios depresivos o síntomas del ánimo bajo'],
        peso: 1,
      },
      {
        paciente: 'Pánico',
      ...
      {
        paciente: 'Emociones intensas',
        psicologo: [
          'Procesos depresivos / Regulación emocional y manejo de impulsividad',
        ],
        peso: 1,
      },
      {
        paciente: 'Pensamientos repetitivos',
        psicologo: ['Trastorno obsesivo compulsivo (TOC)'],
        peso: 1,
      },
      { paciente: 'Fobia', psicologo: ['Fobias específicas'], peso: 1 },
      {
        paciente: 'Ansiedad social',
        psicologo: [
          'Trastornos de ansiedad (incluye crisis de pánico, ansiedad generalizada, ansiedad social)',
        ],
        peso: 1,
      ...
      {
        paciente: 'Autolesión',
        psicologo: ['Conductas autolesivas sin intención suicida'],
        peso: 1,
      },
      {
        paciente: 'Ideación suicida',
        psicologo: [
          'Pensamientos suicidas o ideación sin planificación activa',
        ],
        peso: 1,
      },
      {
      ...
      },
      {
        paciente: 'TDAH',
        psicologo: [
          'Trastorno de déficit atencional (TDAH) en adolescentes o adultos',
        ],
        peso: 1,
      },
      {
        paciente: 'Impulsividad',
        psicologo: ['Regulación emocional y manejo de impulsividad'],
        peso: 1,
      },
      {
        paciente: 'Personalidad',
        psicologo: ['Trastornos de personalidad leves a moderados'],
        peso: 1,
      },
      {
        paciente: 'TEA',
        psicologo: [
          'Trastorno del espectro autista (TEA) sin discapacidad intelectual',
        ],
        peso: 1,
      },
      {
        paciente: 'Dificultades adaptativas',
        psicologo: ['Trastornos adaptativos'],
        peso: 1,
      },
      {
        paciente: 'Salud física',
        psicologo: [
          'Impacto psicológico por diagnóstico de enfermedad médica crónica',
        ],
        peso: 1,
      },
      {
        paciente: 'Alimentación',
        psicologo: ['Trastornos de la conducta alimentaria (TCA)'],
        peso: 1,
      },
      {
        paciente: 'Consumo de alcohol o drogas',
        psicologo: ['Consumo problemático de alcohol u otras sustancias'],
        peso: 1,
      },
      {
        paciente: 'Sexualidad / Género',
        psicologo: [
          'Dificultades relacionadas con la identidad de género o la orientación sexual / Disfunciones sexuales',
        ],
        peso: 1,
      },
    ],
    ...
    mapeosTemas: [
      {
        paciente: 'Autoconocimiento',
        psicologo: ['Acompañamiento en procesos de autoconocimiento'],
        peso: 1,
      },
      {
        paciente: 'Autoestima',
        psicologo: ['Fortalecimiento de la autoestima y la autovaloración'],
        peso: 1,
      },
      {
        paciente: 'Autonomía',
        psicologo: [
          'Procesos de individuación o separación emocional de la familia de origen',
        ],
        peso: 1,
      },
      {
        paciente: 'Límites',
        psicologo: [
          'Dificultades para poner límites o cuidar el espacio personal',
        ],
        peso: 1,
      },
      {
        paciente: 'Perdón',
        psicologo: [
          'Exploración de identidad personal / Procesamiento emocional',
        ],
        peso: 1,
      },
      {
        paciente: 'Identidad',
        psicologo: [
          'Exploración de identidad personal / Temáticas ligadas al género, diversidad e identidad sexual',
        ],
        peso: 1,
      },
      {
        paciente: 'Regulación emocional',
        psicologo: ['Regulación emocional y manejo de impulsividad'],
        peso: 1,
      },
      {
        paciente: 'Sobreexigencia',
        psicologo: [
          'Culpabilidad excesiva o autoexigencia desmedida / Agotamiento emocional y estrés por sobreexigencia',
        ],
        peso: 1,
      },
      {
        paciente: 'Evitación',
        psicologo: ['Evitación de experiencias dolorosas o toma de decisiones'],
        peso: 1,
      },
      {
        paciente: 'Relaciones',
        psicologo: [
          'Conflictos en relaciones cercanas (familia, pareja, amistades)',
        ],
        peso: 1,
      },
      {
        paciente: 'Patrones vinculares',
        psicologo: ['Repetición de patrones vinculares o conductuales'],
        peso: 1,
      },
      {
        paciente: 'Conflictos familiares',
        psicologo: [
          'Conflictos en relaciones cercanas (familia, pareja, amistades)',
        ],
        peso: 1,
      ...
      {
        paciente: 'Parentalidad',
        psicologo: ['Parentalidad y crianza'],
        peso: 1,
      },
      {
        paciente: 'Trauma',
        psicologo: ['Procesamiento de experiencias traumáticas'],
        peso: 1,
      },
      {
        paciente: 'Abuso',
        psicologo: [
          'Procesamiento de experiencias de abuso (físico, emocional o sexual)',
        ],
        peso: 1,
      },
      {
        paciente: 'Duelo',
        psicologo: ['Duelo por pérdidas significativas o rupturas importantes'],
        peso: 1,
      },
      {
        paciente: 'Crisis existencial',
        psicologo: ['Crisis vitales o existenciales'],
        peso: 1,
      },
      {
        paciente: 'Cambios vitales',
        psicologo: [
          'Adaptación frente a cambios profundos o inesperados en la vida',
        ],
        peso: 1,
      },
      {
        paciente: 'Género y sexualidad',
        psicologo: [
          'Temáticas ligadas al género, diversidad e identidad sexual',
        ],
        peso: 1,
      },
      {
        paciente: 'Discriminación',
        psicologo: ['Vivencias de discriminación o exclusión'],
        peso: 1,
      },
    ],
    ...
    mapeosEstilo: [
      {
        paciente: 'Que sea auténtico/a',
        psicologo: ['Auténtico/a y coherente consigo mismo/a'],
        peso: 1,
      },
      {
        paciente: 'Que hable claro y con calma',
        psicologo: ['Comunicativo/a y claro/a al expresarse'],
        peso: 1,
      },
      {
        paciente: 'Que me haga sentir en confianza',
        psicologo: ['Cercano/a y humano/a en el vínculo'],
        peso: 1,
      },
      {
        paciente: 'Que tenga cercanía humana',
        psicologo: ['Cálido/a y cuidadoso/a en la relación'],
        peso: 1,
      },
      {
        paciente: 'Que tenga algo de humor',
        psicologo: ['Dinámico/a o con estrategias creativas'],
        peso: 1,
      },
      {
        paciente: 'Que se preocupe por cómo estoy',
        psicologo: ['Atento/a al vínculo terapéutico como eje del proceso'],
        peso: 1,
      },
      {
        paciente: 'Que valore el vínculo',
        psicologo: ['Atento/a al vínculo terapéutico como eje del proceso'],
        peso: 1,
      },
      {
        paciente: 'Que construyamos el proceso juntos/as',
        psicologo: ['Horizontal, promueve una construcción compartida'],
        peso: 1,
      },
      {
        paciente: 'Que sepa escuchar, pero también decir lo que necesito',
        psicologo: ['Comunicativo/a y claro/a al expresarse'],
        peso: 1,
      },
      {
        paciente: 'Que me oriente cuando lo necesito',
        psicologo: ['Activo/a en la conducción de las sesiones'],
        peso: 1,
      },
      {
        paciente: 'Que tenga estructura y claridad en el trabajo',
        psicologo: ['Con estructura y orden en el trabajo clínico'],
        peso: 1,
      },
      {
        paciente: 'Que se adapte a mi ritmo',
        psicologo: ['Flexible y abierto/a a adaptar el proceso'],
        peso: 1,
      },
      {
        paciente: 'Que me explique las cosas con base',
        psicologo: ['Tiende puentes entre teoría y práctica'],
        peso: 1,
      },
      {
        paciente: 'Que me ayude a pensar en profundidad',
        psicologo: ['Reflexivo/a y promotor/a de la introspección'],
        peso: 1,
      },
    ],
    ...
    mapeosEnfoque: [
      {
        paciente: 'Quiero herramientas prácticas para sentirme mejor',
        psicologo: ['Cognitivo-Conductual (TCC)', 'Integrativo'],
        peso: 1,
      },
      {
        paciente: 'Quiero entender por qué me pasa lo que me pasa',
        psicologo: ['Psicoanalítico', 'Psicodinámico', 'Humanista'],
        peso: 1,
      },
      {
        paciente: 'Prefiero que el/la terapeuta me guíe activamente',
        psicologo: ['Cognitivo-Conductual', 'Sistémico', 'Integrativo'],
        peso: 1,
      },
      {
        paciente: 'Necesito solo hablar y sentirme escuchado/a sin juicios',
        psicologo: ['Humanista', 'Psicoanalítico'],
        peso: 1,
      },
      {
        paciente:
          'Me interesa trabajar temas de infancia o vínculos familiares',
        psicologo: ['Psicoanalítico', 'Sistémico'],
        peso: 1,
      },
      {
        paciente: 'Tengo un objetivo puntual o específico que quiero resolver',
        psicologo: [
      ...
      {
        paciente:
          'Quiero que me dejen avanzar a mi ritmo, sin tanta intervención',
        psicologo: ['Humanista', 'Psicoanalítico'],
        peso: 1,
      },
      {
        paciente: 'Estoy en crisis y necesito contención urgente',
        psicologo: ['Humanista', 'Sistémico', 'Integrativo'],
        peso: 1,
      },
      {
        paciente:
          'Estoy buscando mejorar la relación con mi pareja o mi familia',
        psicologo: ['Sistémico'],
        peso: 1,
      },
      {
        paciente:
          'Quiero alguien que me enseñe técnicas para manejar mis emociones o mis pensamientos',
        psicologo: [
          'Cognitivo-Conductual',
      ...
      {
        paciente: 'Me interesa trabajar desde el cuerpo o lo experiencial',
        psicologo: ['Gestalt', 'Terapias Corporales'],
        peso: 1,
      },
      {
        paciente: 'Me interesa una terapia con respaldo científico comprobado',
        psicologo: [
          'Cognitivo-Conductual',
      ...
      {
        paciente: 'Busco un espacio para explorar mi mundo interior, sin apuro',
        psicologo: ['Psicoanalítico', 'Humanista'],
        peso: 1,
      },
      {
        paciente:
          'Me interesa una terapia con estructura, pasos y plazos claros',
        psicologo: [
          'Cognitivo-Conductual',
          'Sistémico',
    ...
    mapeosAfinidad: [
      {
        paciente: 'Genuino/a',
        psicologo: ['Genuino/a y transparente'],
        peso: 1,
      },
      {
        paciente: 'Cariñoso/a',
        psicologo: ['Cariñoso/a o de trato cálido'],
        peso: 1,
      },
      {
        paciente: 'Alegre',
        psicologo: ['Alegres o con energía vital positiva'],
        peso: 1,
      },
      {
        paciente: 'Reflexivo/a',
        psicologo: ['Reflexivo/a o con disposición a mirar hacia adentro'],
        peso: 1,
      },
      {
        paciente: 'Respetuoso/a',
        psicologo: ['De trato respetuoso y abierto/a a otras formas de pensar'],
        peso: 1,
      },
      {
        paciente: 'Confiable',
        psicologo: ['Confiable o comprometido/a con el proceso'],
        peso: 1,
      },
      {
        paciente: 'Sensible',
        psicologo: ['Sensible ante lo que viven otros/as'],
        peso: 1,
      },
      {
        paciente: 'Divertido/a',
        psicologo: ['Divertido/a o con humor inteligente'],
        peso: 1,
      },
      {
        paciente: 'Dispuesto/a al cambio',
        psicologo: ['Dispuesto/a a aprender o cambiar'],
        peso: 1,
      },
      {
        paciente: 'Reservado/a',
        psicologo: ['Reservado/a, pero receptivo/a'],
        peso: 1,
      },
      {
        paciente: 'Expresivo/a',
        psicologo: ['Espontáneo/a y expresivo/a'],
        peso: 1,
      },
      {
        paciente: 'Colaborativo/a',
        psicologo: ['Colaborativo/a o con ganas de construir en conjunto'],
        peso: 1,
      },
      {
        paciente: 'Honesto/a',
        psicologo: ['Honesto/a, aunque a veces le cueste expresarse'],
        peso: 1,
      },
      {
        paciente: 'Cauteloso/a',
        psicologo: ['Cauteloso/a, pero comprometido/a'],
        peso: 1,
      },
      {
        paciente: 'Flexible',
        psicologo: ['Flexible ante nuevas perspectivas'],
        peso: 1,
      },
      {
        paciente: 'Entusiasta',
        psicologo: ['Entusiasta o motivado/a'],
        peso: 1,
      },
      {
        paciente: 'Crítico/a constructivo/a',
        psicologo: ['Con mirada crítica pero constructiva'],
        peso: 1,
      },
      {
        paciente: 'Intenso/a emocionalmente',
        psicologo: ['Emocionalmente intenso/a'],
        peso: 1,
      },
      {
        paciente: 'Paciente',
        psicologo: ['Paciente o con ritmo propio'],
        peso: 1,
      },
      {
        paciente: 'Introspectivo/a',
        psicologo: ['Introspectivo/a y profundo/a'],
        peso: 1,
      },
    ],
  };
  ...
  async calcularMatching(pacienteId: string): Promise<ResultadoMatching[]> {
    ...
    for (const psicologo of psicologos) {
      const resultado = await this.calcularMatchingIndividual(
        paciente,
        psicologo,
      );
  ...
  async calcularMatchingConRespuestas(
    ...
    for (const psicologo of psicologos) {
      const resultado = await this.calcularMatchingIndividualConRespuestas(
  ...
  private async calcularMatchingIndividual(
    ...
    const puntajeDiagnosticos = this.calcularPuntajeDiagnosticos(
      paciente,
      psicologo,
    );
  ...
  private async calcularMatchingIndividualConRespuestas(
    ...
    const puntajeDiagnosticos = this.calcularPuntajeDiagnosticosConRespuestas(
      respuestasFormulario,
      psicologo,
    );
    const puntajeTemas = this.calcularPuntajeTemasConRespuestas(
      respuestasFormulario,
      psicologo,
    );
    const puntajeEstilo = this.calcularPuntajeEstiloConRespuestas(
      respuestasFormulario,
      psicologo,
    );
    const puntajeEnfoque = this.calcularPuntajeEnfoqueConRespuestas(
      respuestasFormulario,
      psicologo,
    );
    const puntajeAfinidad = this.calcularPuntajeAfinidadConRespuestas(
      respuestasFormulario,
      psicologo,
    );
    const puntajeFiltros = this.calcularPuntajeFiltrosConRespuestas(
      respuestasFormulario,
      psicologo,
    );
    ...
    return {
      ...
      coincidencias: {
        ...
        filtros: this.obtenerCoincidenciasFiltrosConRespuestas(
          respuestasFormulario,
          psicologo,
        ),
      },
   ...
   */
  private calcularPuntajeDiagnosticos(
    paciente: Paciente,
    psicologo: Psicologo,
  ): number {
   ...
   */
  private calcularPuntajeEnfoque(
    paciente: Paciente,
    psicologo: Psicologo,
  ): number {
    return this.calcularPuntajeCriterio(
   ...
   */
  private calcularPuntajeAfinidad(
    paciente: Paciente,
    psicologo: Psicologo,
  ): number {
    return this.calcularPuntajeCriterio(
   ...
   */
  private calcularPuntajeFiltros(
    paciente: Paciente,
    psicologo: Psicologo,
  ): number {
    let puntaje = 0;
    ...
    if (
      paciente.genero_psicologo_preferido.includes('Indiferente') ||
      paciente.genero_psicologo_preferido.includes(
        this.mapearGenero(psicologo.genero),
      )
    ) {
      puntaje += 1;
    }
    ...
    // Filtro de modalidad
    if (
      paciente.modalidad_preferida.includes('Indiferente') ||
      this.hayCoincidenciaModalidad(
        paciente.modalidad_preferida,
  ...
  private calcularPuntajeDiagnosticosConRespuestas(
    respuestasFormulario: any,
    psicologo: Psicologo,
  ): number {
    return this.calcularPuntajeCriterio(
  ...
  private calcularPuntajeTemasConRespuestas(
    respuestasFormulario: any,
    psicologo: Psicologo,
  ): number {
    return this.calcularPuntajeCriterio(
  ...
  private calcularPuntajeEstiloConRespuestas(
    respuestasFormulario: any,
    psicologo: Psicologo,
  ): number {
    return this.calcularPuntajeCriterio(
  ...
  private calcularPuntajeEnfoqueConRespuestas(
    respuestasFormulario: any,
    psicologo: Psicologo,
  ): number {
    return this.calcularPuntajeCriterio(
  ...
  private calcularPuntajeAfinidadConRespuestas(
    respuestasFormulario: any,
    psicologo: Psicologo,
  ): number {
    return this.calcularPuntajeCriterio(
  ...
  private calcularPuntajeFiltrosConRespuestas(
    respuestasFormulario: any,
    psicologo: Psicologo,
  ): number {
    let puntaje = 0;
    ...
    // Filtro de género del psicólogo
    if (
      respuestasFormulario.genero_psicologo_preferido?.includes(
        'Indiferente',
      ) ||
      respuestasFormulario.genero_psicologo_preferido?.includes(
        this.mapearGenero(psicologo.genero),
    ...
    // Filtro de modalidad
    if (
      respuestasFormulario.modalidad_preferida?.includes('Indiferente') ||
      this.hayCoincidenciaModalidad(
        respuestasFormulario.modalidad_preferida || [],
        psicologo.modalidad_atencion,
      )
    ) {
      puntaje += 1;
  ...
  private obtenerCoincidenciasFiltrosConRespuestas(
    respuestasFormulario: any,
    psicologo: Psicologo,
  ): string[] {
    ...
    if (
      ...
      const modalidadesCoincidentes = psicologo.modalidad_atencion.filter(
        (m) =>
          respuestasFormulario.modalidad_preferida?.includes(m) ||
          respuestasFormulario.modalidad_preferida?.includes('Indiferente'),
      );
   ...
   */
  private obtenerCoincidenciasFiltros(
    paciente: Paciente,
    psicologo: Psicologo,
  ): string[] {
    const coincidencias: string[] = [];
    ...
    if (
      ...
      const modalidadesCoincidentes = psicologo.modalidad_atencion.filter(
        (m) =>
          paciente.modalidad_preferida.includes(m) ||
          paciente.modalidad_preferida.includes('Indiferente'),
      );
      coincidencias.push(`Modalidad: ${modalidadesCoincidentes.join(', ')}`);
    }
   ...
   */
  private hayCoincidenciaModalidad(
    preferencias: string[],
    ofrecidas: string[],
  ): boolean {
  ...
  async crearPerfilMatchingPsicologo(
    ...
    try {
      ...
      console.error(
        `[MatchingService] Error al crear perfil de matching:`,
        error,
      );
      throw error;
    }
  ...
  async crearPerfilMatchingPaciente(
    ...
    paciente.diagnosticos_principales =
      perfilDto.diagnosticos_principales || [];
    paciente.temas_principales = perfilDto.temas_principales || [];
    paciente.estilo_terapeutico_preferido =
      perfilDto.estilo_terapeutico_preferido || [];
    paciente.enfoque_teorico_preferido =
      perfilDto.enfoque_teorico_preferido || [];
    paciente.afinidad_personal_preferida =
      perfilDto.afinidad_personal_preferida || [];
    paciente.genero = perfilDto.genero;
    paciente.modalidad_preferida = perfilDto.modalidad_preferida || [];
    paciente.genero_psicologo_preferido =
      perfilDto.genero_psicologo_preferido || [];
  ...
  async verificarPerfilCompleto(userId: string): Promise<boolean> {
    ...
    if (!psicologo) {
      console.log(
        `[MatchingService] No se encontró psicólogo para usuario: ${userId}`,
      );
      return false;
    }
    ...
    console.log(
      `[MatchingService] Verificación perfil completo para usuario ${userId}:`,
      {
  ...
  async activarCuentaPsicologo(userId: string): Promise<void> {
    try {
      ...
      console.log(
        `[MatchingService] Psicólogo encontrado para usuario ${userId}:`,
        {
          psicologoId: psicologo.id,
      ...
      if (psicologo.usuario.estado === 'PENDIENTE') {
        ...
        console.log(
          `[MatchingService] Usuario ${psicologo.usuario.id} activado exitosamente de PENDIENTE a ACTIVO`,
        );
      } else {
        console.log(
          `[MatchingService] Usuario ${psicologo.usuario.id} ya está activo (estado: ${psicologo.usuario.estado})`,
        );
      }
    } catch (error) {
      console.error(
        `[MatchingService] Error al activar cuenta del psicólogo para usuario ${userId}:`,
        error,
      );
      throw error;
    }
    ...
    try {
      ...
      if (pacienteTemporalId.startsWith('temp_')) {
        ...
        if (paciente) {
          ...
          console.log(
            `[MatchingService] Perfil temporal ${pacienteTemporalId} eliminado`,
          );
        }
      }
    } catch (error) {
      console.warn(
        `[MatchingService] Error al limpiar perfil temporal ${pacienteTemporalId}:`,
        error,
      );
    }
  }
