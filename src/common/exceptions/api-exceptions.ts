...
export class InvalidCredentialsException extends HttpException {
  constructor(
    message = 'Credenciales inválidas. Compruebe su correo electrónico y contraseña.',
  ) {
    super(
      {
...
export class TokenExpiredException extends HttpException {
  constructor(
    message = 'El token de autenticación ha expirado. Por favor, inicie sesión de nuevo.',
  ) {
    super(
      {
        statusCode: HttpStatus.UNAUTHORIZED,
...
export class RateLimitExceededException extends HttpException {
  constructor(
    message = 'Ha excedido el límite de solicitudes. Por favor, espere antes de intentar nuevamente.',
...
export class InvalidOperationException extends HttpException {
  constructor(
    message = 'La operación solicitada no es válida en el contexto actual',
...
export class UnsupportedMediaTypeException extends HttpException {
  constructor(
    message = 'Tipo de contenido no soportado. Verifique la cabecera Content-Type de su solicitud.',
  ) {
    super(
      {
...
export class PayloadTooLargeException extends HttpException {
  constructor(
    message = 'La solicitud es demasiado grande. Por favor, reduzca el tamaño de los datos enviados.',
  ) {
    super(
      {
...
export class ExternalServiceException extends HttpException {
  constructor(
    serviceName = 'servicio externo',
    message = `Error al comunicarse con el ${serviceName}`,
  ) {
    super(
      {
