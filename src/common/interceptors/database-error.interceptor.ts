        ...
        if (error instanceof QueryFailedError) {
            ...
            return throwError(
              () =>
                new BadRequestException(
                  'La referencia a otro registro no es válida. Compruebe que el ID referenciado existe.',
                ),
            );
          }
            ...
            return throwError(
              () =>
                new DatabaseConnectionException(
                  'No se pudo establecer conexión con la base de datos. Vuelva a intentarlo en unos momentos.',
                ),
            );
          }
          ...
          if (message.includes('check constraint')) {
            return throwError(
              () =>
                new BadRequestException(
                  'El valor proporcionado no cumple con las restricciones de validación de la base de datos',
                ),
            );
          }
          ...
          if (
            ...
            return throwError(
              () =>
                new BadRequestException(
                  'Formato de datos inválido. Compruebe que los tipos de datos son correctos.',
                ),
            );
          }
